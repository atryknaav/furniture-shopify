...
const Product = (props: ProductProps) => {
  ...
  return (
    ...
    href={'/product?id=' + id}
    >
    <div className=' flex flex-col gap-2 group hover:cursor-pointer ml-12 h-full active:cursor-wait pb-20'>
        ...
        <div className=' px-3 text-sm tb:text-xl font-normal text-[#1c1c1c] max-h-[2rem]'>
            {description}
        </div>
